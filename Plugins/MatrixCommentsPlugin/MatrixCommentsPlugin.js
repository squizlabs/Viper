...
(function(ViperUtil, ViperSelection, _) {
    ...
    Viper.PluginManager.addPlugin('MatrixCommentsPlugin', MatrixCommentsPlugin);
    ...
    MatrixCommentsPlugin.prototype = {
        ...
        {
        	var self       = this;
        	var addCommmentBtn = self.viper.Tools.createButton('vitpMatrixComments', '', _('Add Comment'), 'Viper-add-comments', function() {
        		self.newComment();
        	});
    		var buttonGroup = self.viper.Tools.createButtonGroup('vitpCommentsBtnGroup');
    		self.viper.Tools.addButtonToGroup('vitpMatrixComments', 'vitpCommentsBtnGroup');
        ...
        updateInlineToolbar: function(data)
        {
            if(this._allowCommentSystem && !this._readOnly) {
                ...
                if(node && ViperUtil.hasAttribute(node, 'data-comment-id')) {
                    this.viper.Tools.setButtonActive('vitpMatrixComments');
                }
            }
        },
