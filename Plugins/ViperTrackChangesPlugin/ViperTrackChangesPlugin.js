...
(function(ViperUtil, ViperSelection, _) {
    ...
    Viper.PluginManager.addPlugin('ViperTrackChangesPlugin', ViperTrackChangesPlugin);
    ...
    ViperTrackChangesPlugin.prototype = {
        ...
        toggleTrackChanges: function()
        {
            ...
            if (this._barActive === true) {
                this.viper.Tools.setButtonActive('trackChanges');
            } else {
                this.viper.Tools.setButtonInactive('trackChanges');
            }
