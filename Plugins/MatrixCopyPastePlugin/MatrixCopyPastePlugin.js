(function(ViperUtil, ViperSelection, _) {
    ...
    {
        this._parent = viper.getPluginManager().getPluginObject('ViperCopyPastePlugin');
    ...
    Viper.PluginManager.addPlugin('MatrixCopyPastePlugin', MatrixCopyPastePlugin, 'ViperCopyPastePlugin');

    MatrixCopyPastePlugin.prototype = {
        init: function()
        {
            this._parent.prototype.init.call(this);
