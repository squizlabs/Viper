...
class Viper_Tests_ViperImagePlugin_ImageUnitTest extends AbstractViperUnitTest
{
    ...
    public function testBlankAltAttributeInSource()
    {
        ...
        $this->keyDown('Key.ENTER');
         ...
         $this->assertHTMLMatch('<h1>Viper Image Plugin Unit Tests</h1><p>LOREM XuT dolor</p><img src="http://cms.squizsuite.net/__images/homepage-images/hero-shot.jpg" alt="" /><p>sit amet <strong>WoW</strong></p><p>Squiz LABS is ORSM</p>');
    ...
    public function testInsertingAnImageAtEndOfParagraph()
    {
        ...
        $this->assertHTMLMatch('<h1>Viper Image Plugin Unit Tests</h1><p>LOREM XuT dolor</p><img src="http://cms.squizsuite.net/__images/homepage-images/hero-shot.jpg" alt="Alt tag" /><p>sit amet <strong>WoW</strong></p><p>Squiz LABS is ORSM</p>');
        ...
        $this->assertHTMLMatch('<h1>Viper Image Plugin Unit Tests</h1><p>LOREM XuT dolor</p><img src="http://cms.squizsuite.net/__images/homepage-images/hero-shot.jpg" alt="Alt tag" /><p>sit amet <strong>WoW</strong></p><p>Squiz LABS is ORSM</p><img src="http://cms.squizsuite.net/__images/homepage-images/hero-shot.jpg" alt="Alt tag" />');
    ...
    public function testReplacingContentWithAnImage()
    {
        ...
        $this->assertHTMLMatch('<h1>Viper Image Plugin Unit Tests</h1><img src="http://cms.squizsuite.net/__images/homepage-images/hero-shot.jpg" alt="Alt tag" /><p>sit amet <strong>WoW</strong></p><p>Squiz LABS is ORSM</p>');
        ...
        $this->assertHTMLMatch('<h1>Viper Image Plugin Unit Tests</h1><img src="http://cms.squizsuite.net/__images/homepage-images/hero-shot.jpg" alt="Alt tag" /> <p>sit amet <strong>WoW</strong></p><p>Squiz <img src="http://cms.squizsuite.net/__images/homepage-images/hero-shot.jpg" alt="Alt tag" /> is ORSM</p>');
     ...
     * @return void
     */
    public function testInsertingAndDeletingImageUsingTheIcon()
    {
        $dir = dirname(__FILE__).'/Images/';
