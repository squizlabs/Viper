...
class Viper_Tests_ViperFormatPlugin_AlignmentUnitTest extends AbstractViperUnitTest
{
    ...
    public function testAligningAnImage()
    {
        ...
        $this->clickTopToolbarButton($dir.'toolbarIcon_alignRight.png');
        $this->assertHTMLMatch('<p>Australian governments at all levels have <strong><em>endorsed</em></strong> WCAG 2.0, and require all government websites (federal, state and territory) to meet the new guidelines at the minimum compliance level (Single A) by the end of 2012.</p><p><img src="http://cms.squizsuite.net/__images/homepage-images/hero-shot.jpg" alt="" width="354" height="160.5854748603352" style="display: block; float: right; margin-top: 1em; margin-right: 0px; margin-bottom: 1em; margin-left: 1em;" />Federal government agencies must update <strong>all government</strong> websites (as specified within scope under the Website Accessibility National Transition Strategy (NTS)) to WCAG 2.0 conformance.</p>');
        $this->assertTrue($this->topToolbarButtonExists($dir.'toolbarIcon_alignRight_active.png'), 'Active right justify icon does not appear in the top toolbar');
