...
class Viper_Tests_ViperKeywordPlugin_ImageKeywordUnitTest extends AbstractViperImagePluginUnitTest
{
    ...
    public function testImageKeywordTitleChange()
    {
        ...
        $expectedRawHTML = '<p>test content %1%</p>	<p>more content <img class="__viper_selHighlight __viper_cleanOnly" data-viper-attribite-keywords="true" title="test" alt="TITLE" src="../../Examples/Paper-reel/Images/testImage.png" data-viper-src="((prop:url))"> even more content</p>';
        ...
        $expectedRawHTML = '<p>test content %1%</p>	<p>more content <img class="__viper_selHighlight __viper_cleanOnly" data-viper-attribite-keywords="true" title="test title" alt="TITLE" src="../../Examples/Paper-reel/Images/testImage.png" data-viper-src="((prop:url))"> even more content</p>';
        $actualRawHTML = $this->getRawHtml();
        $this->assertEquals($expectedRawHTML, $actualRawHTML);
        ...
        $expectedRawHTML = '<p>test content %1%</p><p>more content <img alt="TITLE" src="./Images/testImage.png" data-viper-src="((prop:url))" data-viper-attribite-keywords="true" title="test"> even more content</p>';
        $actualRawHTML = $this->getRawHtml();
        $this->assertEquals($expectedRawHTML, $actualRawHTML);
        ...
        $expectedRawHTML = '<p>test content %1%</p><p>more content <img alt="TITLE" src="./Images/testImage.png" data-viper-src="((prop:url))" data-viper-attribite-keywords="true" title="test title"> even more content</p>';
        $actualRawHTML = $this->getRawHtml();
        $this->assertEquals($expectedRawHTML, $actualRawHTML);
    ...
    public function testChangeImageKeywordDecorative()
    {
        ...
        $expectedRawHTML = '<p>test content %1%</p>	<p>more content <img class="__viper_selHighlight __viper_cleanOnly" alt="TITLE" data-viper-attribite-keywords="true" src="../../Examples/Paper-reel/Images/testImage.png" data-viper-src="((prop:url))"> even more content</p>';
        $actualRawHTML = $this->getRawHtml();
        $this->assertEquals($expectedRawHTML, $actualRawHTML);
        ...
        $expectedRawHTML = '<p>test content %1%</p>	<p>more content <img data-viper-attribite-keywords="true" src="../../Examples/Paper-reel/Images/testImage.png" data-viper-src="((prop:url))"> even more content</p>';
        $actualRawHTML = $this->getRawHtml();
        $this->assertEquals($expectedRawHTML, $actualRawHTML);
        ...
        $expectedRawHTML = '<p>test content %1%</p>	<p>more content <img alt="TITLE" data-viper-attribite-keywords="true" src="../../Examples/Paper-reel/Images/testImage.png" data-viper-src="((prop:url))"> even more content</p>';
        $actualRawHTML = $this->getRawHtml();
        $this->assertEquals($expectedRawHTML, $actualRawHTML);
    ...
    public function testCopyAndPasteImageKeyword()
    {
        ...
        $expectedRawHTML = '<p>test content %1%</p><p><img alt="TITLE" src="http://localhost/~slabs/Viper/Examples/Paper-reel/Images/testImage.png" data-viper-src="((prop:url))"></p><p>more content <img alt="TITLE" src="../../Examples/Paper-reel/Images/testImage.png" data-viper-src="((prop:url))"> even more content</p>';
        $actualRawHTML = $this->getRawHtml();
        $this->assertEquals($expectedRawHTML, $actualRawHTML);
    ...
    public function testCutAndPasteImageKeyword()
    {
        ...
        $expectedRawHTML = '<p>test content %1%</p><p><img alt="TITLE" src="http://localhost/~slabs/Viper/Examples/Paper-reel/Images/testImage.png" data-viper-src="((prop:url))"></p><p>more content  even more content</p>';
        $actualRawHTML = $this->getRawHtml();
        $this->assertEquals($expectedRawHTML, $actualRawHTML);
    ...
    public function testResizingImageKeyword()
    {
        ...
        $expectedRawHTML = '<p>test content %1%</p><p>more content <img alt="TITLE" src="../../Examples/Paper-reel/Images/testImage.png" data-viper-src="((prop:url))" width="100" height="85"> even more content</p>';
        $actualRawHTML = $this->getRawHtml();
        $this->assertEquals($expectedRawHTML, $actualRawHTML);
