...
class Viper_Tests_ViperInlineToolbarPlugin_InlineToolbarFormatsUnitTest extends AbstractViperUnitTest
{
    ...
    public function testPChangesToQuoteInLineage()
    {
        ...
        $this->clickInlineToolbarButton(dirname(dirname(__FILE__)).'/ViperFormatPlugin/Images/toolbarIcon_blockquote.png');
    ...
    public function testPChangesToDivInLineage()
    {
        ...
        $this->selectInlineToolbarLineageItem(0);
        $this->clickInlineToolbarButton(dirname(dirname(__FILE__)).'/ViperFormatPlugin/Images/toolbarIcon_toggle_formats_highlighted.png');
        $this->clickInlineToolbarButton(dirname(dirname(__FILE__)).'/ViperFormatPlugin/Images/toolbarIcon_div.png');
    ...
    public function testPChangesToH2InLineage()
    {
        ...
        $this->selectInlineToolbarLineageItem(0);
        $this->clickInlineToolbarButton(dirname(dirname(__FILE__)).'/ViperFormatPlugin/Images/toolbarIcon_heading.png');
        $this->clickInlineToolbarButton(dirname(dirname(__FILE__)).'/ViperFormatPlugin/Images/toolbarIcon_h2.png');
