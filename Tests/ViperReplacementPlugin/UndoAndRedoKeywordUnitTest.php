...
class Viper_Tests_ViperReplacementPlugin_UndoAndRedoKeywordUnitTest extends AbstractViperImagePluginUnitTest
{
    ...
    public function testUndoAndRedoDeletingImageKeywords()
    {
        ...
        $this->assertRawHTMLMatch('<p>%1% test content<span data-viper-keyword="((prop:viperKeyword))" title="((prop:viperKeyword))">%5%</span></p><p>more content<img alt="TITLE" data-viper-src="((prop:url))" src="../../Examples/Paper-reel/Images/testImage.png"> even more content</p>');
    ...
    {   
        ...
        $this->assertRawHTMLMatch('<p>%1% test content<span data-viper-keyword="((prop:viperKeyword))" title="((prop:viperKeyword))">%5%</span></p><p>more content<img alt="TITLE" data-viper-src="((prop:url))" height="170" src="../../Examples/Paper-reel/Images/testImage.png" width="200"> even more content</p>');
