...
class Viper_Tests_ViperReplacementPlugin_LinksWithKeywordsUnitTest extends AbstractViperUnitTest
{
    ...
    public function testLinkOnKeyword()
    {
        ...
        $this->assertRawHTMLMatch('<p>%1% <keyword title="((prop:productName))" data-viper-keyword="((prop:productName))" contenteditable="false"><a href="www.squizlabs.com.au">Viper</a></keyword> %2%</p>');
        ...
        $this->assertRawHTMLMatch('<p>%1% <keyword title="((prop:productName))" data-viper-keyword="((prop:productName))" contenteditable="false">Viper</keyword> %2%</p>');
