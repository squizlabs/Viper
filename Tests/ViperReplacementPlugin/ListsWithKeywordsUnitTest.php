...
class Viper_Tests_ViperReplacementPlugin_ListsWithKeywordsUnitTest extends AbstractViperUnitTest
{
    ...
    public function testImageKeywordUnorderedList()
    {
        ...
        $this->assertRawHTMLMatch('<ul><li>%1% Test content<img alt="TITLE" data-viper-src="((prop:url))" src="../../Examples/Paper-reel/Images/testImage.png"> more test content.%2%</li></ul>');
        // Test for revert
        $this->selectKeyword(1, 2);
        $this->clickTopToolbarButton('listUL', 'active');
        
        $this->assertHTMLMatch('<p>%1% Test content <img alt="TITLE" src="((prop:url))" /> more test content.%2%</p>');
        $this->assertRawHTMLMatch('<p>%1% Test content<img alt="TITLE" data-viper-src="((prop:url))" src="../../Examples/Paper-reel/Images/testImage.png"> more test content.%2%</p>');
    ...
    public function testImageKeywordOrderedList()
    {
        ...
        $this->assertRawHTMLMatch('<ol><li>%1% Test content<img alt="TITLE" data-viper-src="((prop:url))" src="../../Examples/Paper-reel/Images/testImage.png"> more test content.%2%</li></ol>');
        // Test for revert
        $this->selectKeyword(1, 2);
        $this->sikuli->keyDown('Key.SHIFT + Key.RIGHT');
        $this->clickTopToolbarButton('listOL', 'active');
