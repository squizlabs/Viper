...
class Viper_Tests_ViperCopyPastePlugin_CopyAndCutImagesUnitTest extends AbstractViperUnitTest
{
    ...
    public function testCopyPasteImageWithTextBefore()
    {
        ...
        $this->sikuli->keyDown('Key.CMD + v');
        sleep(1);
        $this->assertHTMLMatch('<p>First paragraph</p><p>text %1% <img src="%url%/ViperImagePlugin/Images/editing.png" alt="Alt tag" /> %2% text</p><p>This is the second paragraph in the content of the page %3%</p><p>%1%<img src="file:///Users/slabs/Sites/Viper/Examples/Paper-reel/%url%/ViperImagePlugin/Images/editing.png" alt="Alt tag" /></p>');
    ...
    public function testCutPasteImage()
    {
        ...
        $this->sikuli->keyDown('Key.CMD + v');
        sleep(1);
        $this->assertHTMLMatch('<p>First paragraph</p><p>text %1% %2% text</p><p>This is the second paragraph in the content of the page %3%</p><p><img src="file:///Users/slabs/Sites/Viper/Examples/Paper-reel/%url%/ViperImagePlugin/Images/editing.png" alt="Alt tag" /></p>');
    ...
    public function testCutPasteImageWithTextBefore()
    {
        ...
        $this->sikuli->keyDown('Key.CMD + v');
        sleep(1);
        $this->assertHTMLMatch('<p>First paragraph</p><p>text&nbsp;&nbsp;%2% textThis is the second paragraph in the content of the page %3%</p><p>%1%<img src="file:///Users/slabs/Sites/Viper/Examples/Paper-reel/%url%/ViperImagePlugin/Images/editing.png"alt="Alt tag"/></p>');
