            ...
            case 'windows':
                switch ($this->sikuli->getBrowserid()) {
                    ...
                    case 'chrome':
                        ...
                        break;
                    case 'ie8':
                        $testFile = $this->getTestURL('/ViperCopyPastePlugin/TextFiles/WindowsIE8/WordDocs/Lists.txt');
                        break;
                    case 'ie9':
                        $testFile = $this->getTestURL('/ViperCopyPastePlugin/TextFiles/WindowsIE9/WordDocs/Lists.txt');
                        break;
                    case 'ie10':
