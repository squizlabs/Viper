...
class Viper_Tests_ViperCopyPastePlugin_CopyPasteInTablesUnitTest extends AbstractViperUnitTest
{
    ...
    public function testCopyAndPasteContentFromTable()
    {
        ...
        $this->removeTableHeaders();
        sleep(1);
        $this->assertHTMLMatch('<p>Lorem XAX</p><table border="1" style="width:100%;"><tbody><tr><td>test</td><td>sapien XBX vel aliquet</td><td><ul><li>purus neque luctus ligula, vel molestie arcu</li><li>purus neque luctus</li><li>vel molestie arcu</li></ul></td></tr></tbody></table><p>sapien XBX vel aliquet</p><p>sit amet<strong>consectetur</strong></p><p>eooee</p><table border="1" cellpadding="3" cellspacing="0"><caption><strong>Table 1.2:</strong> The table caption text</caption><thead><tr><th>Col1 Header</th><th>Col2 Header</th><th>Col3 Header</th></tr></thead><tfoot><tr><td colspan="3">This is the table footer</td></tr></tfoot><tbody><tr><td>test</td><td>sapien XBX vel aliquet</td><td><ul><li>purus neque luctus ligula, vel molestie arcu</li><li>purus neque luctus</li><li>vel molestie arcu</li></ul></td></tr><tr><td>nec porta ante</td><td colspan="2">purus neque luctus<strong><a href="http://www.google.com">ligula</a></strong>, vel molestie arcu</td></tr><tr><td>nec<strong>porta</strong> ante</td><td><p>sapien vel aliquet XCX</p>testsapien XBX vel aliquet<ul><li>purus neque luctus ligula, vel molestie arcu</li><li>purus neque luctus</li><li>vel molestie arcu</li></ul><p><br />sapien XBX vel aliquet</p></td><td rowspan="2">purus neque luctus ligula, vel molestie arcu</td></tr><tr><td colspan="2">sapien vel aliquet</td></tr></tbody></table>');
