...
class Viper_Tests_ViperListPlugin_OrderedListUnitTest extends AbstractViperListPluginUnitTest
{
    ...
    public function testCreatingNewListAndDeletingIt()
    {
        ...
        $this->clickTopToolbarButton('listOL');
        $this->assertHTMLMatch('<p>%1% uuuuuu. %2%</p><p>This is content</p><ol><li>%10% Item one</li><li>Item two</li><li>Item three %11%</li></ol><p>End content</p><p>cPOc ccccc dddd. %3%</p><p>ajhsd sjsjwi hhhh:</p><ol><li>aaa %4% ccccc</li><li>%5% %6% templates</li><li>Audit %7% %8%</li><li>Accessibility audit report</li><li>Recommendations %9% plan</li><li>Squiz Matrix guide</li></ol>');
