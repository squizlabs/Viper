...
class Viper_Tests_ViperListPlugin_UnorderedListUnitTest extends AbstractViperUnitTest
{
     ...
     * @return void
     */
    public function testListCreationgFromTextSelection()
    {
        $this->selectText('VmumV');
    ...
    }//end testListCreationgFromTextSelection()
     ...
     * @return void
     */
    public function testListCreationgFromParaSelection()
    {
        $this->selectText('XabcX', 'VmumV');
    ...
    }//end testListCreationgFromParaSelection()
